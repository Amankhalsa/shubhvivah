            ...
            <div class="col-md-4">
                      ...
                      <div class="row mt-3">
                        ...
                        <div class="col-md-12"><label class="labels">Postcode</label>
                            <input type="text" class="form-control" name="postcode" value="{{$edit_users->postcode}}">
                            @error('postcode')
                            <span class="text-danger"> {{$message}}</span>
                            @enderror
                        </div>
                        <div class="col-md-12"><label class="labels">Education </label>
                            <textarea class="form-control" name="education" rows="3"> {!!html_entity_decode($edit_users->education)!!}	</textarea>
                            @error('education')
                            <span class="text-danger"> {{$message}}</span>
                            @enderror
                        </div>
