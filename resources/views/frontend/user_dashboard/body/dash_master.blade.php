...
<head>
    ...
    <meta name="description" content="shubhvivah">
    <meta name="author" content="shubhvivah">
    <meta name="keywords" content="shubhvivah">
...
<body class="animsition">
    <div class="page-wrapper">
        <!-- HEADER MOBILE-->
      @include('frontend.user_dashboard.body.mobileheader')
        <!-- END HEADER MOBILE-->

        <!-- MENU SIDEBAR-->
      @include('frontend.user_dashboard.body.sidebar')
        ...
        <div class="page-container">
            <!-- HEADER DESKTOP-->
      @include('frontend.user_dashboard.body.desk_header')
